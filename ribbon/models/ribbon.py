...
class ribbonMedalForce(models.Model):
    ...
    ribbon_ids=fields.Many2many("ribbon",'ribbon_force_medal_rel',column1='force_id',column2="ribbon_id",string="ribbons")
...
class ribbonRegulation(models.Model):
    ...
    ribbon_id=fields.Many2one('ribbon',"Name Of Ribbon/Medal")
