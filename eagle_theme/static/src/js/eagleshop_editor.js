eagle.define('eagle_theme.eagleshop_editor_js', function(require) {
    ...
    options.registry.eagle_theme_blog_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".eagleshop_blog_slider").on("click", _.bind(self.eagle_theme_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_theme_blog_slider()) {
                this.eagle_theme_blog_slider().fail(function() {
        ...
        eagle_theme_blog_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/eagle_theme/blog_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.eagle_theme_multi_cat_custom_snippet = options.Class.extend({
        ...
        multi_category_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/eagle_theme/product_multi_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.eagle_theme_coming_soon_mode_one = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            ...
            if (!editMode) {
                self.$el.find(".biztech_coming_soon_mode_one").on("click", _.bind(self.eagle_theme_coming_soon_mode_one_function, self));
            }
        },
        ...
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_theme_coming_soon_mode_one_function()) {
                self.eagle_theme_coming_soon_mode_one_function.fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
    ...
    options.registry.eagle_theme_coming_soon_mode_two = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            ...
            if (!editMode) {
                self.$el.find(".biztech_coming_soon_mode_two").on("click", _.bind(self.eagle_theme_coming_soon_mode_two_function, self));
            }
        },
        ...
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_theme_coming_soon_mode_two_function()) {
                self.eagle_theme_coming_soon_mode_two_function.fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
    ...
    options.registry.eagle_theme_category_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
        ...
        cat_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/eagle_theme/category_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.eagle_theme_product_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
        ...
        prod_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/eagle_theme/product_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
                        $("select[id='slider_type'").append($('<option>', {
                            value: y["id"],
    ...
    options.registry.eagle_theme_featured_product_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
        ...
        featured_prod_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/eagle_theme/featured_product_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
    ...
    options.registry.eagle_theme_news1_js = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            ...
            if (!editMode) {
                self.$el.find(".eagleshop_newsone_slider").on("click", _.bind(self.eagle_theme_newsone_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_theme_newsone_slider()) {
                this.eagle_theme_newsone_slider().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
    ...
    options.registry.eagle_theme_news2_js = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            ...
            if (!editMode) {
                self.$el.find(".eagleshop_newstwo_slider").on("click", _.bind(self.eagle_theme_newstwo_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_theme_newstwo_slider()) {
                this.eagle_theme_newstwo_slider().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
    ...
    options.registry.eagle_theme_hardware_blog_snippet = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            this.$target.find('.eagle_theme_new_blog').empty();
            if (!editMode) {
                self.$el.find(".eagle_theme_new_blog").on("click", _.bind(self.eagle_theme_new_blog_function, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.eagle_theme_new_blog_function()) {
                this.eagle_theme_new_blog_function().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
    ...
    options.registry.eagle_theme_faq_three_tabing = options.Class.extend({
        start: function() {
            var self = this;
    ...
    options.registry.eagle_theme_faq_one_tabing = options.Class.extend({
        start: function() {
            var self = this;
