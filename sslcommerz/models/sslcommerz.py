...
class SSLCOMMERZ(models.Model):
    _name='sslcommerz.payment.gateway'
    store_id =fields.Char('Store Id')
    store_pass = fields.Char('Password')
    issandbox = fields.Boolean('Is Sandbox')
    mode = fields.Char("mode")
    createSessionUrl = fields.Char("Session Url")
    validation_url = fields.Char("validation URL")
    transaction_url = fields.Char("transaction URL")
