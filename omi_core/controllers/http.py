from eagle.http import Response, WebRequest
from eagle.service import model as service_model
...
def _call_function(self, *args, **kwargs):
    """
    Monkey patching method. Eagle 11.0
    ...
    TODO: Cần tìm giải pháp tối ưu hơn, ví dụ tạo một server riêng để nhận request rồi, chuyển về 1 type và gửi về eagle
          https://github.com/eagle/eagle/issues/7766#issuecomment-230753503
    """
    request = self
